...
public:
     ...
     * @param del If true, remove VLAN ID policy from the given interface. Also, optional arguments
     * are irrelevant in that case.
     * @param vid VLAN ID to set/remove, if given value is '0' apply for all possible VIDs.
