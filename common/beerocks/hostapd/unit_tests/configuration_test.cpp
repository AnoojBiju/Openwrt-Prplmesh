...
const std::string
    configuration_content("driver=nl80211\n"
                          "logger_syslog=127\n"
                          ...
                          "ieee80211n=1\n"
                          "ht_coex=0\n"
                          "ht_capab=[HT40+][LDPC][SHORT-GI-20][SHORT-GI-40][TX-STBC][RX-STBC1][MAX-"
                          "AMSDU-7935][DSSS_CCK-40]\n"
                          "vht_oper_chwidth=1\n"
                          "vht_oper_centr_freq_seg0_idx=42\n"
                          "ieee80211ac=1\n"
                          "vht_capab=[RXLDPC][SHORT-GI-80][TX-STBC-2BY1][RX-ANTENNA-PATTERN][TX-"
                          "ANTENNA-PATTERN][RX-STBC-1][MAX-MPDU-11454][MAX-A-MPDU-LEN-EXP7]\n"
