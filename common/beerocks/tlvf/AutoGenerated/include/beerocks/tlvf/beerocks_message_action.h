...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_CHANNEL_SCAN_DUMP_RESULTS_REQUEST = 0x49,
    ACTION_BACKHAUL_CHANNEL_SCAN_DUMP_RESULTS_RESPONSE = 0x4a,
    ACTION_BACKHAUL_CHANNEL_SCAN_TRIGGERED_NOTIFICATION = 0x4b,
    ACTION_BACKHAUL_CHANNEL_SCAN_RESULTS_NOTIFICATION = 0x4c,
    ACTION_BACKHAUL_CHANNEL_SCAN_ABORT_REQUEST = 0x4d,
    ACTION_BACKHAUL_CHANNEL_SCAN_ABORT_RESPONSE = 0x4e,
    ACTION_BACKHAUL_CHANNEL_SCAN_ABORTED_NOTIFICATION = 0x4f,
    ACTION_BACKHAUL_CHANNEL_SCAN_FINISHED_NOTIFICATION = 0x50,
