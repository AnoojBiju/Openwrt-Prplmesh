...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_HOSTAP_CONFIG_SPATIAL_REUSE_REQUEST = 0x45,
...
enum eActionOp_APMANAGER: uint8_t {
    ...
    ACTION_APMANAGER_HOSTAP_SPATIAL_REUSE_REQUEST = 0x24,
    ...
    ACTION_APMANAGER_UNASSOC_STA_LINK_METRICS_RESPONSE = 0x49,
