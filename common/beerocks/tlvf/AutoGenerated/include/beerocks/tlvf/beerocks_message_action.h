...
enum eActionOp_APMANAGER: uint8_t {
    ...
    ACTION_APMANAGER_HOSTAP_ZWDFS_ANT_CHANNEL_SWITCH_REQUEST = 0x1e,
    ACTION_APMANAGER_HOSTAP_ZWDFS_ANT_CHANNEL_SWITCH_RESPONSE = 0x1f,
