...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_APPLY_VLAN_POLICY_REQUEST = 0x15,
    ...
    ACTION_BACKHAUL_CHANNELS_LIST_REQUEST = 0x2d,
    ACTION_BACKHAUL_CHANNELS_LIST_RESPONSE = 0x2e,
    ACTION_BACKHAUL_HOSTAP_CHANNEL_SWITCH_ACS_START = 0x2f,
    ACTION_BACKHAUL_HOSTAP_CSA_NOTIFICATION = 0x30,
    ACTION_BACKHAUL_HOSTAP_CSA_ERROR_NOTIFICATION = 0x31,
    ACTION_BACKHAUL_HOSTAP_DFS_CAC_STARTED_NOTIFICATION = 0x32,
    ACTION_BACKHAUL_HOSTAP_DFS_CAC_COMPLETED_NOTIFICATION = 0x33,
    ACTION_BACKHAUL_HOSTAP_ZWDFS_ANT_CHANNEL_SWITCH_REQUEST = 0x34,
    ACTION_BACKHAUL_HOSTAP_ZWDFS_ANT_CHANNEL_SWITCH_RESPONSE = 0x35,
    ACTION_BACKHAUL_CHANNEL_SCAN_TRIGGER_SCAN_REQUEST = 0x36,
    ACTION_BACKHAUL_CHANNEL_SCAN_TRIGGER_SCAN_RESPONSE = 0x37,
    ACTION_BACKHAUL_CHANNEL_SCAN_DUMP_RESULTS_REQUEST = 0x38,
    ACTION_BACKHAUL_CHANNEL_SCAN_DUMP_RESULTS_RESPONSE = 0x39,
    ACTION_BACKHAUL_CHANNEL_SCAN_TRIGGERED_NOTIFICATION = 0x3a,
    ACTION_BACKHAUL_CHANNEL_SCAN_RESULTS_NOTIFICATION = 0x3b,
    ACTION_BACKHAUL_CHANNEL_SCAN_ABORT_REQUEST = 0x3c,
    ACTION_BACKHAUL_CHANNEL_SCAN_ABORT_RESPONSE = 0x3d,
    ACTION_BACKHAUL_CHANNEL_SCAN_ABORTED_NOTIFICATION = 0x3e,
    ACTION_BACKHAUL_CHANNEL_SCAN_FINISHED_NOTIFICATION = 0x3f,
    ACTION_BACKHAUL_ENUM_END = 0x40,
};
...
enum eActionOp_APMANAGER: uint8_t {
    ...
    ACTION_APMANAGER_HOSTAP_ADD_4ADDR_STA_UPDATE = 0x16,
    ACTION_APMANAGER_HOSTAP_DEL_4ADDR_STA_UPDATE = 0x17,
    ...
    ACTION_APMANAGER_SET_ASSOC_DISALLOW_REQUEST = 0x3a,
