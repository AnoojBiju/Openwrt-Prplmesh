...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_SET_SPATIAL_REUSE_PARAMS = 0x52,
    ACTION_BACKHAUL_GET_SPATIAL_REUSE_PARAMS = 0x53,
...
enum eActionOp_APMANAGER: uint8_t {
    ...
    ACTION_APMANAGER_HOSTAP_SPATIAL_REUSE_REPORT_NOTIFICATION = 0x24,
    ...
    ACTION_APMANAGER_SET_SPATIAL_REUSE_PARAMS = 0x4b,
    ACTION_APMANAGER_GET_SPATIAL_REUSE_PARAMS = 0x4c,
