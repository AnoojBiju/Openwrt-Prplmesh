...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_HOSTAP_CSA_NOTIFICATION = 0x2f,
    ACTION_BACKHAUL_HOSTAP_CSA_ERROR_NOTIFICATION = 0x30,
    ACTION_BACKHAUL_HOSTAP_DFS_CAC_STARTED_NOTIFICATION = 0x31,
    ACTION_BACKHAUL_HOSTAP_DFS_CAC_COMPLETED_NOTIFICATION = 0x32,
    ACTION_BACKHAUL_HOSTAP_ZWDFS_ANT_CHANNEL_SWITCH_REQUEST = 0x33,
    ACTION_BACKHAUL_HOSTAP_ZWDFS_ANT_CHANNEL_SWITCH_RESPONSE = 0x34,
    ACTION_BACKHAUL_ENUM_END = 0x35,
};
