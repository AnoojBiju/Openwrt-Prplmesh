...
protected:
    ...
    std::unique_ptr<nl80211_client>
        m_iso_nl80211_client; //impl nl80211 client apis with whm backend

    //this is a pointer to the base class of m_iso_nl80211_client, to avoid repetitive cast
    bwl::nl80211_client_whm *m_iso_nl80211_client_whm;
