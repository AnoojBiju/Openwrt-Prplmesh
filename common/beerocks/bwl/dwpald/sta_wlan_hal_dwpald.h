...
public:
    ...
    virtual int hap_evt_disconnected_clb(char *ifname, char *op_code, char *msg,
                                         size_t len) override;
    virtual int hap_evt_terminating_clb(char *ifname, char *op_code, char *msg,
                                        size_t len) override;
    virtual int hap_evt_scan_results_clb(char *ifname, char *op_code, char *msg,
                                         size_t len) override;
    virtual int hap_evt_channel_switch_clb(char *ifname, char *op_code, char *msg,
                                           size_t len) override;
