...
bool ap_wlan_hal_dwpal::sta_acceptlist_remove(const sMacAddr &mac, const sMacAddr &bssid)
{
    LOG(TRACE) << __func__ << " - NOT IMPLEMENTED!";
    return false;
}

bool ap_wlan_hal_dwpal::sta_acceptlist_add(const sMacAddr &mac, const sMacAddr &bssid)
{
    LOG(TRACE) << __func__ << " - NOT IMPLEMENTED!";
    return false;
}
