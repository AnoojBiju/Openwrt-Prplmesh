...
bool ap_wlan_hal_dwpald::add_key(const std::string &ifname, const sKeyInfo &key_info)
{
    LOG(TRACE) << __func__ << " - NOT IMPLEMENTED!";
    return false;
}

bool ap_wlan_hal_dwpald::add_station(const std::string &ifname, const sMacAddr &mac, assoc_frame::AssocReqFrame &assoc_req)
{
    LOG(TRACE) << __func__ << " - NOT IMPLEMENTED!";
    return false;
}
