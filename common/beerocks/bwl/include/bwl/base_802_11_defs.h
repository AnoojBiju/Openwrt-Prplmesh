...
struct s80211MgmtFrame {
    ...
    struct sHeader {
        ...
        uint8_t da[beerocks::net::MAC_ADDR_LEN];    // Destination MAC Address
        uint8_t sa[beerocks::net::MAC_ADDR_LEN];    // Source MAC Address
        uint8_t bssid[beerocks::net::MAC_ADDR_LEN]; // BSSID (AP MAC Address)
