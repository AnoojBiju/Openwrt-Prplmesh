...
public:
     ...
     * 
     * @param [out] sta_qos_ctrl_params - To hold qos control params of associated wifi6 clients.
     * @param [in] vap_iface_name - Name of vap interface to which wifi6 sta is associated.
     * 
