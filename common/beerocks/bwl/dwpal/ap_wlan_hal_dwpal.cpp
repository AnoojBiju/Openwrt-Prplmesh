                                                         ...
                                                         bool radio_5G, int8_t &result)
{
    ...
    if (numOfValidArgs[7] == 0) {
        result = generate_association_event_result::FAILED_CLIENT_NOT_ASSOCAITED;
        return nullptr;
    }
            ...
            if (!msg_buff) {
                if (result == generate_association_event_result::FAILED_TO_PARSE_DWPAL) {
                    ...
                    break;
                           ...
                           generate_association_event_result::FAILED_CLIENT_NOT_ASSOCAITED) {
