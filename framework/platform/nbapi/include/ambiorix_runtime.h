...
public:
    ...
    */
    static int Initialize(int argc, char *argv[], amxrt_arg_fn_t handler)
    {
        index = 0;
   ...
   * @return  Non zero indicates an error
    ...
    */
    ...
    /**
    * @brief Creates and initializes all needed event loop components.
    * 
    ...
    * 
    * 
    * @return 0 when the event loop components are created and initialized correctly.
    * Any other return value indicates an error.
    */
    static int CreateEventLoop()
    {
        return amxrt_el_create();
        // Add error handling if needed
    }
    ...
    */
    static int RunEventLoop() { return amxrt_el_start(); }
