...
public:
    ...
    start_transaction(const std::string &relative_path, bool new_instance = false) = 0;
    ...
    {
        auto trans = start_transaction(relative_path);
    ...
    */
    ...
    {
        auto trans = start_transaction(path_to_object);
    ...
    */
    ...
    {
        return commit_transaction(start_transaction(relative_path, true));
    }
