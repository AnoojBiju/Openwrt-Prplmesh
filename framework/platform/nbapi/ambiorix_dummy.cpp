...
bool AmbiorixDummy::apply_transaction(amxd_trans_t &transaction) { return true; }
void AmbiorixDummy::stop() {}
bool AmbiorixDummy::remove_instance(const std::string &relative_path, uint32_t index)
{
    return true;
}
amxd_object_t *AmbiorixDummy::prepare_transaction(const std::string &relative_path,
                                                  amxd_trans_t &transaction)
{
    amxd_object_t object;
    amxd_object_t *object_ptr;
