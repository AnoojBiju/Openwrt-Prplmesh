...
void create_custom_ebtable_chains(std::string prerouting_chain_name,
                                  std::string postrouting_chain_name)
{
...
bool write_dscp_map_to_proc(uint8_t *dscp, std::string filename)
{
    int i = 0;
