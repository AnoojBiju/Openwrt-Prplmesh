...
uint8_t* tlvAffiliatedStaMetrics::reserved(size_t idx) {
...
bool tlvAffiliatedStaMetrics::set_reserved(const void* buffer, size_t size) {
    if (buffer == nullptr) {
...
bool tlvAffiliatedStaMetrics::alloc_reserved(size_t count) {
