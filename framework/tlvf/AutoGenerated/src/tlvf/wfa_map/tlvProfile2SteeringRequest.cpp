...
tlvProfile2SteeringRequest::tlvProfile2SteeringRequest(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
tlvProfile2SteeringRequest::tlvProfile2SteeringRequest(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
tlvProfile2SteeringRequest::~tlvProfile2SteeringRequest() {
}
const eTlvTypeMap& tlvProfile2SteeringRequest::type() {
    return (const eTlvTypeMap&)(*m_type);
}

const uint16_t& tlvProfile2SteeringRequest::length() {
    return (const uint16_t&)(*m_length);
}

sMacAddr& tlvProfile2SteeringRequest::bssid() {
    return (sMacAddr&)(*m_bssid);
}

tlvProfile2SteeringRequest::sRequestFlags& tlvProfile2SteeringRequest::request_flags() {
    return (sRequestFlags&)(*m_request_flags);
}

uint16_t& tlvProfile2SteeringRequest::steering_opportunity_window_sec() {
    return (uint16_t&)(*m_steering_opportunity_window_sec);
}

uint16_t& tlvProfile2SteeringRequest::btm_disassociation_timer_ms() {
    return (uint16_t&)(*m_btm_disassociation_timer_ms);
}

uint8_t& tlvProfile2SteeringRequest::sta_list_length() {
    return (uint8_t&)(*m_sta_list_length);
}

std::tuple<bool, sMacAddr&> tlvProfile2SteeringRequest::sta_list(size_t idx) {
...
bool tlvProfile2SteeringRequest::alloc_sta_list(size_t count) {
...
uint8_t& tlvProfile2SteeringRequest::target_bssid_list_length() {
    return (uint8_t&)(*m_target_bssid_list_length);
}

std::tuple<bool, tlvProfile2SteeringRequest::sTargetBssidInfo&> tlvProfile2SteeringRequest::target_bssid_list(size_t idx) {
...
bool tlvProfile2SteeringRequest::alloc_target_bssid_list(size_t count) {
...
void tlvProfile2SteeringRequest::class_swap()
{
...
bool tlvProfile2SteeringRequest::finalize()
{
    if (m_parse__) {
...
size_t tlvProfile2SteeringRequest::get_initial_size()
{
    size_t class_size = 0;
...
bool tlvProfile2SteeringRequest::init()
{
    ...
    if (!m_parse__) *m_type = eTlvTypeMap::TLV_PROFILE2_STEERING_REQUEST;
    ...
    if (m_parse__) {
        if (*m_type != eTlvTypeMap::TLV_PROFILE2_STEERING_REQUEST) {
            TLVF_LOG(ERROR) << "TLV type mismatch. Expected value: " << int(eTlvTypeMap::TLV_PROFILE2_STEERING_REQUEST) << ", received value: " << int(*m_type);
            return false;
        }
    }
    return true;
