...
public:
     ...
     * only on the bridge, ethernet ports and and the wireless backhaul interface.
     */
    static void apply_traffic_separation(const std::string &radio_iface = std::string());
...
private:
     ...
     * @param vlans_of_bridge List of VLANs of the bridge information. 
     */
    static void assign_ip_to_vlan_iface(std::list<sBridgeVlanInfo> &vlans_of_bridge);
};
} // namespace net
} // namespace beerocks
