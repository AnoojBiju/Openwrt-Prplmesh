...
void ApAutoConfigurationTask::configuration_complete_wait_action(const std::string &radio_iface)
{
    ...
    LOG(INFO) << "configuration_complete_wait_action num_of_bss_available "
              << radio_conf_params.num_of_bss_available << " enabled_bssids "
              << radio_conf_params.enabled_bssids.size() << " radio_iface " << radio_iface;
