...
const std::string DynamicChannelSelectionTask::fsm_state_to_string(eState status)
{
    switch (status) {
    case eState::INIT:
        return "INIT";
...
DynamicChannelSelectionTask::DynamicChannelSelectionTask(backhaul_manager &btl_ctx,
                                                         ieee1905_1::CmduMessageTx &cmdu_tx)
    : Task(eTaskType::DYNAMIC_CHANNEL_SELECTION), m_btl_ctx(btl_ctx), m_cmdu_tx(cmdu_tx)
{
}

void DynamicChannelSelectionTask::work()
{
...
void DynamicChannelSelectionTask::handle_event(uint8_t event_enum_value, const void *event_obj)
{
...
bool DynamicChannelSelectionTask::handle_cmdu(ieee1905_1::CmduMessageRx &cmdu_rx,
