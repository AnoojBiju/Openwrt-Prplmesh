...
public:
    ...
    enum eEvent : uint8_t { START_CHANNEL_SCAN };
...
private:
     ...
     * 
     */
    enum class eState : uint8_t { UNCONFIGURED, INIT, IDLE };
     ...
     * Value:   channel scan task state struct of the mapped Front radio interface name.
     */
