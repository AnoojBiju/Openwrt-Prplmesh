...
class ChannelTlvs(Enum):
    ...
    CHANNEL_109 = (
        "0x06 "
        "{0x83 0x37 {0x01 0x05 0x09 0x0D 0x11 0x15 0x19 0x1D 0x21 0x25 0x29 0x2D "
        "0x31 0x35 0x39 0x3D 0x41 0x45 0x49 0x4D 0x51 0x55 0x59 0x5D 0x61 0x65 0x69 "
        "0x71 0x75 0x79 0x7D 0x81 0x85 0x89 0x8D 0x91 0x95 0x99 0x9D 0xA1 0xA5 0xA9 "
        "0xAD 0xB1 0xB5 0xB9 0xBD 0xC1 0xC5 0xC9 0xCD 0xD1 0xD5 0xD9 0xDD} 0x00} "
        "{0x84 0x1B {0x03 0x0B 0x13 0x1B 0x23 0x2B 0x33 0x3B 0x43 "
        "0x4B 0x53 0x5B 0x63 0x73 0x7B 0x83 0x8B 0x93 0x9B 0xA3 "
        "0xAB 0xB3 0xBB 0xC3 0xCB 0xD3 0xDB} 0x00} "
        "{0x85 0x0D {0x07 0x17 0x27 0x37 0x47 0x57 0x77 0x87 0x97 "
        "0xA7 0xB7 0xC7 0xD7} 0x00} "
        "{0x86 0x06 {0x0F 0x2F 0x4F 0x8F 0xAF 0xCF} 0x00} "
        "{0x87 {0x00 0x00}} "
        "{0x88 {0x00 0x00}}"
    )
