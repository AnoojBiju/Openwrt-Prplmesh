...
amxo-cg -G xml "${rootdir}/build/controller/nbapi/odl/prplmesh_definitions.odl"
popd || exit 1
if [ ! -r "${rootdir}/build/prplmesh_definitions.odl.xml" ]; then
...
amxo-xml-to -x html\
                  ...
                  -o copyrights="Prpl"\
                  "${rootdir}/build/prplmesh_definitions.odl.xml"
