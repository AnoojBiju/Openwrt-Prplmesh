...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "OSP platform, build on prplos UPDK 9.1.50 + pWHM 6.20.3"
        OPENWRT_TOOLCHAIN_VERSION='7021e8b0c9000e2a3d04cd0990dece553c74faa9'
        OPENWRT_VERSION='7021e8b0c9000e2a3d04cd0990dece553c74faa9'
    else
