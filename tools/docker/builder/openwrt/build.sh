...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        OPENWRT_TOOLCHAIN_VERSION='d00422409a82f6784494a75d0ac5229836771e4d'
        OPENWRT_VERSION='d00422409a82f6784494a75d0ac5229836771e4d'
    elif [[ "urx_osp" == "$TARGET_DEVICE" ]] ; then
        dbg "OSP platform, build on prplos-v3.0.1"
        OPENWRT_TOOLCHAIN_VERSION='439e439792c4c8e21c5c93c843ec8e5c9185414b'
        OPENWRT_VERSION='439e439792c4c8e21c5c93c843ec8e5c9185414b'
    else
