...
main() {
    ...
    if [ -n "$WHM_ENABLE" ] ; then
        OPENWRT_TOOLCHAIN_VERSION='75373dc8910e11d752e70b3b26fbc9acdc4bec5c'
        OPENWRT_VERSION='75373dc8910e11d752e70b3b26fbc9acdc4bec5c'
    fi
...
OPENWRT_TOOLCHAIN_VERSION='847b0def50de7e135dd369e3ddf14870d1fdf891'
OPENWRT_VERSION='847b0def50de7e135dd369e3ddf14870d1fdf891'
