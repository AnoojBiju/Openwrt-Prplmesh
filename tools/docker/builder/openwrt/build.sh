...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "OSP platform, build on prplos UPDK 9.1.50 + pWHM 5.42.9"
        OPENWRT_TOOLCHAIN_VERSION='a1b4ee5cb12720570dceb9572f0e886f492ece6b'
        OPENWRT_VERSION='a1b4ee5cb12720570dceb9572f0e886f492ece6b'
    else
