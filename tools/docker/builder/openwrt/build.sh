...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "Haze platform, build on mm/Haze-prplos-M1-PPM-2598-bump-pwhm-and-lib"
        OPENWRT_TOOLCHAIN_VERSION='d78879f79d29f9779eaa9e86a668388b44d297f2'
        OPENWRT_VERSION='d78879f79d29f9779eaa9e86a668388b44d297f2'
