...
run ip link add          wlan4    type dummy
run ip link add          wlan4.0  type dummy
run ip link add          wlan4.1  type dummy
run ip link add          wlan4.2  type dummy
run ip link add          wlan4.3  type dummy
...
run ip link set      dev wlan4    master br-lan
run ip link set      dev wlan4.0  master br-lan
run ip link set      dev wlan4.1  master br-lan
run ip link set      dev wlan4.2  master br-lan
run ip link set      dev wlan4.3  master br-lan
...
run ip link set      dev wlan4    up
run ip link set      dev wlan4.0  up
run ip link set      dev wlan4.1  up
run ip link set      dev wlan4.2  up
run ip link set      dev wlan4.3  up
