...
int bml_internal::set_client_roaming_11k_support(bool enable)
{
    //CMDU message
    auto request =
        message_com::create_vs_message<beerocks_message::cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST>(
            cmdu_tx);
...
int bml_internal::get_client_roaming_11k_support(int &result)
{
    //CMDU message
    auto request =
        message_com::create_vs_message<beerocks_message::cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST>(
            cmdu_tx);
