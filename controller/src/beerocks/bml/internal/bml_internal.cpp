        ...
        case beerocks_message::ACTION_BML_GET_UNASSOC_STA_QUERY_RESULT_RESPONSE: {
            ...
            if (m_prmUnAssocStaLinkMetricGet) {
                if (m_unassoc_sta_link_metric) {
                    ...
                    LOG(DEBUG) << "CW: response->measurement_delta="
                               << response->measurement_delta()
                               << " m_unassoc_sta_link_metric->measurement_delta="
                               << m_unassoc_sta_link_metric->measurement_delta << " For STA "
                               << tlvf::mac_to_string(response->sta_mac());
