...
void cli_bml::setFunctionsMapAndArray()
{
    ...
    insertCommandToMap(
        ...
        " time_life_delay_minutes - 1 for true,  0 to never aging, -1 not configured, by default "
        "it's ",
