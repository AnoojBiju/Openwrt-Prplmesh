...
bool master_thread::start()
{
    ...
    LOG(DEBUG) << "Test timer created with fd = " << m_test_timer;
    rollback_actions.emplace_front([&]() { m_timer_manager->remove_timer(m_test_timer); });
                                ...
                                const sMacAddr &src_mac, ieee1905_1::CmduMessageRx &cmdu_rx)
{
    ...
    LOG(DEBUG) << "handle_cmdu(" << iface_index << ", " << dst_mac << ", " << src_mac << ", 0x"
               << std::hex << int(cmdu_rx.getMessageType()) << ")";
                                            ...
                                            ieee1905_1::CmduMessageRx &cmdu_rx)
{
    LOG(DEBUG) << "handle_cmdu_from_broker(" << iface_index << ", " << dst_mac << ", " << src_mac
               << ", 0x" << std::hex << int(cmdu_rx.getMessageType()) << ")";
