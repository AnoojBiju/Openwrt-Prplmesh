...
public:
    ...
    /**
     * @brief Triggers the sending of QoS configuration to a specific agent
     *
     * @param agent_mac MAC address of the target agent
     */
    void trigger_prioritization_config(const std::string &agent_mac);
