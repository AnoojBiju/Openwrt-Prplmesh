...
public:
    ...
    /**
     * @brief get the remaining lifetime of a client
     * 
     ...
     * 
     * @param client_entry the special identifier of a client.
     * @param ValuesMap the client information: timestamp, friendly status.
     * @param results[out] error results for the main load function report.
     */
