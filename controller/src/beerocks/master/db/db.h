...
public:
    ...
    */
    ...
    bool set_radio_state(sAgent::sRadio &radio, beerocks::eNodeState state);
    ...
    bool set_hostap_band_capability(sAgent::sRadio &radio,
    ...
    bool set_hostap_driver_version(sAgent::sRadio &radio, const std::string &version);
