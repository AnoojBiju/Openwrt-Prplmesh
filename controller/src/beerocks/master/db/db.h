...
public:
    ...
    */
    ...
    /**
     * @brief Check if the report records for a given radio has the given timestamp.
     *
     * @param mac MAC address of radio.
     * @param ISO_8601_timestamp Channel scan report's timestamp.
    ...
    /**
     * @brief Check if the report records for a given radio using the scan's index.
     *
    ...
    /**
     * @brief Check if the report records for a given radio using it's set channel list as the key.
     *
     * @param RUID MAC address of radio.
     * @param single_scan Indicated if to use single scan or continuous
     * @return True if record exists, false otherwise.
