...
#ifndef AMBIORIX_BACKAND_PATH
#define AMBIORIX_BACKAND_PATH "/usr/bin/mods/amxb/mod-amxb-ubus.so"
#endif // AMBIORIX_BACKAND_PATH
...
int main(int argc, char *argv[])
{
    ...
    amb_dm_obj->init(AMBIORIX_BACKAND_PATH, AMBIORIX_BUS_URI, CONTROLLER_DATAMODEL_PATH);
#else
