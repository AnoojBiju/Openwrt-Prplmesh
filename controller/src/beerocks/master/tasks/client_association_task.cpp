    ...
    const sMacAddr &src_mac, ieee1905_1::CmduMessageRx &cmdu_rx)
{
    ...
    if (!m_database.set_sta_association_frame(sta_mac, std::vector<uint8_t>(client_capability_report_tlv->association_frame(), client_capability_report_tlv->association_frame() + client_capability_report_tlv->association_frame_length()))) {
