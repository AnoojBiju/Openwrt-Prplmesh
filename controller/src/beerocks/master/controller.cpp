...
{
    // Just dor debug.
    LOG(WARNING) << "Spatial reuse parameters. BSSColor: " << bss_color
    ...
    spatial_reuse_request_tlv->flags2().hesiga_spatial_reuse_value15_allowed =
        (hesiga_spr_value15_allowed ? 1 : 0);
    spatial_reuse_request_tlv->flags2().srg_information_valid = (srg_information_valid ? 1 : 0);
    spatial_reuse_request_tlv->flags2().non_srg_offset_valid  = (non_srg_offset_valid ? 1 : 0);
    spatial_reuse_request_tlv->flags2().psr_disallowed        = (psr_disallowed ? 1 : 0);
