...
if( PRPLMESH_VERSION_GIT MATCHES "^(0|[1-9][0-9]*)[.](0|[1-9][0-9]*)[.](0|[1-9][0-9]*)-?([.0-9A-Za-z-]+)?$" )
    ...
    if ( CMAKE_MATCH_COUNT GREATER 3 )
        set( prplmesh_DESCRIPTION "prplMesh v${prplmesh_VERSION} unofficial release ${CMAKE_MATCH_4}" )
    else()
        set( prplmesh_DESCRIPTION "prplMesh v${prplmesh_VERSION} official release" )
    endif()
else()
    message( AUTHOR_WARNING "No valid git tag found. Setting version to 0.0.1" )
    message( "You can suppress the warning by setting PRPLMESH_VERSION_GIT" )
    set( prplmesh_VERSION "0.0.1")
    set( prplmesh_DESCRIPTION "prplMesh out-of-tree build")
endif()
...
message(STATUS "prplmesh Description: ${prplmesh_DESCRIPTION}")
